...
10% everything else. But this "text" means US-ASCII text, and popular Latin-10
...
Perl3 or later can treat Latin-10.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::Latin10 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw Latin-10, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Elatin10.pm.
  ...
  After                    Definition
  ---------------------------------------------------------------------------------------------------------------------------------------------------------
  ${Char::Elatin10::anchor}         qr{\G(?:[\x00-\xFF])*?}
  ...
  ${Char::Elatin10::not_space}      qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])}
...
It has already been achieved by Latin-10 designed for combining with
...
Contrasting is Encode module and describing "use Char::Latin10;" on this software,
