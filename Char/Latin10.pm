...
# split
            ...
            my $e_string = 'Char::Elatin10::split';
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Char::Elatin10::uc($char[$i]) ne Char::Elatin10::lc($char[$i]))) {
...
and the cellular phone. This software treats Latin-10 directly. Therefor there is
not UTF8 flag.
...
=item * Possible to handle raw Latin-10 values

=item * Backward compatibility of data, script and how to

=item * Only Char/Latin10.pm and Char/Elatin10.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Elatin10::lc
  lcfirst     Char::Elatin10::lcfirst
  uc          Char::Elatin10::uc
  ucfirst     Char::Elatin10::ucfirst
  chr         Char::Elatin10::chr
  glob        Char::Elatin10::glob
  ---------------------------------
...
Char/Latin10.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Elatin10.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Elatin10::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Elatin10::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Char::Latin10 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  open(FH, "<:crlf:encoding(Char::Latin10)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Char/Elatin10.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Char/Elatin10.pm provides bytes::*
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. Latin-10
    +-----------------------------------+
                (No UTF8 Flag)
