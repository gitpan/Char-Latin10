...
######################################################################
#
# Char::Latin10 - Source code filter to Latin-10 script
#
...
sub Char::Latin10::escape_script {
    ...
    if (/^ use Char::Elatin10(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin10 %s;\n%s", $Char::Elatin10::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin10 - Source code filter to escape Latin-10

=head1 SYNOPSIS

  use Char::Latin10;
  use Char::Latin10 version;         --- require version
