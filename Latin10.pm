...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Elatin10::uc($char[$i]) ne Elatin10::lc($char[$i]))) {
            $char[$i] = '[' . Elatin10::uc($char[$i]) . Elatin10::lc($char[$i]) . ']';
        }
...
=item * Only Latin10.pm and Elatin10.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Elatin10::lc
  lcfirst     Elatin10::lcfirst
  uc          Elatin10::uc
  ucfirst     Elatin10::ucfirst
  chr         Elatin10::chr
  glob        Elatin10::glob
  ---------------------------------
...
Latin10.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Elatin10.pm
  --------------------------------------------------------------------
  binmode(...);   Elatin10::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Elatin10::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Latin10 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Latin10 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Latin10)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Elatin10.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Elatin10.pm provides bytes::*
