...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin10 software provides)

Latin10 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin10 software provide)
