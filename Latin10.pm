...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ m/\A [\x00-\xFF] \z/oxms) and (Elatin10::uc($char[$i]) ne Elatin10::lc($char[$i]))) {
...
http://search.cpan.org/dist/Char-Latin10/Latin10/JA.pm
